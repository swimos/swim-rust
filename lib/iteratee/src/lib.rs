...
/// ```
/// use std::num::NonZeroUsize;
/// use crate::iteratee::collect_vec_with_rem;
...
pub trait Iteratee<In> {
    ...
    ///
    /// ```
    /// use crate::iteratee::{identity, Iteratee};
    ///
    ...
    /// ```
    /// use std::num::NonZeroUsize;
    /// use crate::iteratee::{identity, collect_vec, Iteratee};
    ///
    /// let size = NonZeroUsize::new(2).unwrap();
    ///
    ...
    /// ```
    /// use std::num::NonZeroUsize;
    /// use crate::iteratee::{collect_vec, identity, Iteratee};
    ///
    ...
    /// use std::num::NonZeroUsize;
    /// use crate::iteratee::Iteratee;
    /// use crate::iteratee::copy_into_vec;
    ///
    /// let size = NonZeroUsize::new(2).unwrap();
    ///
    ...
    /// use std::num::NonZeroUsize;
    /// use crate::iteratee::Iteratee;
    /// use crate::iteratee::copy_into_vec_with_rem;
    ///
    /// let size = NonZeroUsize::new(2).unwrap();
    ///
    /// let data = vec![1, 2, 3, 4, 5];
    ...
    /// ```
    /// use std::num::NonZeroUsize;
    /// use crate::iteratee::{collect_vec, Iteratee};
    ///
    /// let size = NonZeroUsize::new(2).unwrap();
    ///
...
///
/// ```
/// use crate::iteratee::{unfold, Iteratee};
///
...
///
/// ```
/// use crate::iteratee::{unfold_with_flush, Iteratee};
///
...
/// use std::num::NonZeroUsize;
/// use crate::iteratee::Iteratee;
/// use crate::iteratee::collect_vec;
///
...
///
/// ```
/// use crate::iteratee::collect_all_vec;
/// use crate::iteratee::Iteratee;
...
/// ```
/// use crate::iteratee::Iteratee;
/// use crate::iteratee::utf8_byte_offsets;
