    ...
    P: Point,
{
    ...
    /// # Examples:
    /// ```
    /// use swimos_rtree::{Rect, Point2D, rect, Point3D};
    ///
    ...
    ///
    /// ```should_panic
    /// # use swimos_rtree::{Rect, Point2D, Point3D};
    /// #
    ...
    ///
    /// ```should_panic
    /// # use swimos_rtree::{Rect, rect, Point2D};
    /// #
