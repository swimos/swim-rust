...
use crate::agent::tests::reporting_macro_agent::{EventCollector, EventCollectorHandler};
use crate::agent::tests::{run_agent_test, ReportingAgentEvent};
...
swim_agent! {
    (MacroReportingAgent, TestAgentConfig) => {
        lane(vis: public, path: "map_lane", data: MapLane<String, i32>, watch: Queue) => {
        ...
        lane(vis: public, path: "total", total: ValueLane<i32>, watch: Queue) => {
        ...
        lane(vis: public, path: "action", action: CommandLane<String>, watch: Queue) => {
        ...
        lane(vis: public, path: "demand", demand: DemandLane<i32>, watch: Queue) => {
        ...
        lane(vis: public, path: "demand_map", demand_map: DemandMapLane<String, i32>, watch: Queue) => {
