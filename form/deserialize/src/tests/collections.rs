...
mod valid_types {
    ...
    fn set() {
        ...
        let parsed_value = from_value::<BTreeSet<i32>>(&record).unwrap();
    ...
    fn simple_map() {
        ...
        let parsed_value = from_value::<BTreeMap<&str, i32>>(&record).unwrap();
    ...
    fn map_of_vecs() {
        ...
        let parsed_value = from_value::<BTreeMap<&str, Vec<i32>>>(&record).unwrap();
    ...
    fn map_of_tuples() {
        ...
        let parsed_value =
            from_value::<BTreeMap<&str, (i32, i32, i32, i32, i32)>>(&record).unwrap();
    ...
    fn map_of_structs() {
        ...
        let parsed_value = from_value::<BTreeMap<&str, Test>>(&record).unwrap();
