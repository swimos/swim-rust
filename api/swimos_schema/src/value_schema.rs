...
pub use swimos_schema_derive::ValueSchema;
...
/// use swimos_schema::schema::{StandardSchema, ItemSchema, Schema};
/// use swimos_schema::schema::attr::AttrSchema;
/// use swimos_schema::schema::slot::SlotSchema;
///
/// #[derive(Form)]
/// #
/// struct Cat {
...
/// #
/// struct S {
///     #[form(schema(and(of_kind(ValueKind::Text), text = "swimos")))]
///     company: String
/// }
/// ```
