...
fn tuple_struct_attrs() {
    ...
    struct S(
        ...
        #[form(schema(text = "swimos"))] String,
    );
    ...
    let expected_schema = StandardSchema::HeadAttribute {
        ...
        remainder: Box::new(StandardSchema::Layout {
            items: vec![
                ...
                (ItemSchema::ValueItem(StandardSchema::text("swimos")), true),
            ],
            exhaustive: true,
        }),
    };
