...
use crate::connectors::relay::selector::{
    common::StaticBound,
    common::{Segment, Selector, SelectorBound, SelectorKind, Span},
    node::parse_pattern,
    ParseError, Part,
};
use crate::relay::NodeSelector;
...
fn keys() {
    test(
        ...
        None,
        vec![
            Segment::Static(StaticBound { start: 0, end: 1 }),
    ...
    test(
        ...
        vec![
            ...
            Segment::Static(StaticBound { start: 5, end: 6 }),
            Segment::Selector(Selector::Property {
                kind: SelectorKind::Value,
                parts: vec![],
            }),
            Segment::Static(StaticBound { start: 12, end: 13 }),
            Segment::Selector(Selector::Property {
                kind: SelectorKind::Value,
                parts: vec![
                    SelectorBound {
...
fn escaped() {
    test(
        ...
        vec![
            ...
            Segment::Static(StaticBound { start: 6, end: 7 }),
            Segment::Selector(Selector::Property {
                kind: SelectorKind::Value,
                parts: vec![],
            }),
    ...
    test(
        ...
        vec![
            ...
            Segment::Static(StaticBound { start: 6, end: 12 }),
        ],
    );
}
...
fn mixed() {
    test(
        ...
        vec![
            ...
            Segment::Static(StaticBound { start: 7, end: 8 }),
            Segment::Selector(Selector::Property {
                kind: SelectorKind::Key,
    ...
    test(
        ...
        vec![
            ...
            Segment::Static(StaticBound { start: 21, end: 22 }),
            Segment::Selector(Selector::Property {
                kind: SelectorKind::Value,
                parts: vec![SelectorBound {
                    start: 29,
            ...
            Segment::Static(StaticBound { start: 36, end: 48 }),
        ],
    );
}
...
fn statics() {
    test(
        "/path",
        None,
        vec![Segment::Static(StaticBound { start: 0, end: 5 })],
    );
    test(
        "/a/b/c",
        None,
        vec![Segment::Static(StaticBound { start: 0, end: 6 })],
    );
    test(
        "/a/$key/c",
        None,
        vec![
            Segment::Static(StaticBound { start: 0, end: 3 }),
            Segment::Selector(Selector::Property {
                kind: SelectorKind::Key,
                parts: vec![],
            }),
            Segment::Static(StaticBound { start: 7, end: 9 }),
        ],
    );
}
...
fn scheme_with_static_route() {
    test(
        "node:/blah",
        Some(StaticBound { start: 0, end: 4 }), // "node"
        vec![Segment::Static(StaticBound { start: 5, end: 10 })],
    );
}
...
fn scheme_with_selector_route() {
    test(
        "swim:/$key",
        Some(StaticBound { start: 0, end: 4 }), // "swim"
        vec![
            Segment::Static(StaticBound { start: 5, end: 6 }),
            Segment::Selector(Selector::Property {
                kind: SelectorKind::Key,
...
fn scheme_with_static_and_selector() {
    test(
        ...
        Some(StaticBound { start: 0, end: 4 }), // "swim"
        vec![
            Segment::Static(StaticBound { start: 5, end: 11 }),
            Segment::Selector(Selector::Property {
                kind: SelectorKind::Key,
                parts: vec![],
            }),
...
fn bad_patterns() {
    ...
    assert!(parse_pattern("/$key.field[]".into()).is_err());
    assert!(parse_pattern("/$key.field[".into()).is_err());
    assert!(parse_pattern("/$key.field.[1]".into()).is_err());
    assert!(parse_pattern("/$key.@field[".into()).is_err());
    assert!(parse_pattern("/$key.@field]".into()).is_err());
    assert!(parse_pattern("/$key.@field[]".into()).is_err());
    assert!(parse_pattern("/$key.@field.[]".into()).is_err());
...
fn display() {
    ...
    display_eq("/$value.@attr.field_b");
    display_eq("/$value.@attr.field_b[1]");
    display_eq("/$value.@attr[1]");
...
fn iter_nested() {
    ...
    assert_eq!(
        iter.next(),
        Some(Part::Selector(ValueSelector::Key(ChainSelector::new(
