...
use swimos_agent::event_handler::{
    ActionContext, DownlinkSpawner, EventHandler, EventHandlerError, HandlerAction, HandlerFuture,
...
impl<A> DownlinkSpawner<A> for TestSpawner<A> {
    fn spawn_downlink(
        &self,
        _dl_channel: BoxDownlinkChannel<A>,
